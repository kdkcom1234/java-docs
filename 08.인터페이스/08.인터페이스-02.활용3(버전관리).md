...
public class Main {
    public static void main(String[] args) {
        Versioned fileV1 = new FileV1("example.txt");
        System.out.println("File version (V1): " + fileV1.getVersion());
        fileV1.additionalMethod();

        Versioned fileV2 = new FileV2("example.txt");
        System.out.println("File version (V2): " + fileV2.getVersion());
        fileV2.additionalMethod();
    }
}
```
